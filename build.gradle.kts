...
val kotlinPackageName = "io.github.kotlinmania.icudecimal"
...
kotlin {
    ...
    val xcf = XCFramework("IcuDecimal")

    // Apple desktop
    macosArm64 {
        binaries.framework { baseName = "IcuDecimal"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "IcuDecimal"
        flattenPackage = kotlinPackageName
    }

    android {
        namespace = kotlinPackageName
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "icu-decimal-kotlin", version.toString())

    pom {
        name.set("icu-decimal-kotlin")
        description.set("Kotlin Multiplatform port of unicode-org/icu4x - API for formatting basic decimal numbers in a locale-sensitive way")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/icu-decimal-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/icu-decimal-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/icu-decimal-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/icu-decimal-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    val emptySourceSentinel =
        layout.buildDirectory.file("generated/codeql-empty/CodeqlEmptySourceSentinel.kt")
    ...
    doFirst {
        ...
        val realSourceFiles = sources.files.sortedBy { it.absolutePath }
        val sourceFiles = realSourceFiles.ifEmpty {
