...
This file is the quick-reference operating contract for icu-decimal-kotlin. The longer
...
icu-decimal-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`icu_decimal`](https://crates.io/crates/icu_decimal). Upstream Rust is the behavioral oracle while the
