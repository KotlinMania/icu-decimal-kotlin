...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `IcuDecimal.swiftmodule/`
...
//      `import IcuDecimal` above would fail at compile time.
//
//   2. The static archive `libIcuDecimal.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "IcuDecimal" }` and
//      `flattenPackage = "io.github.kotlinmania.icudecimal"` configuration in
...
//      via the `IcuDecimalLibrary` product.
//
...
final class IcuDecimalExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "IcuDecimal swift module imported cleanly")
    }
}
