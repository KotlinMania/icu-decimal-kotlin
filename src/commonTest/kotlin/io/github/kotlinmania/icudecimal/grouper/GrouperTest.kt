// port-lint: tests icu_decimal/src/grouper.rs
...
class GrouperTest {
    ...
    fun formatterUsesCallerProvidedGroupingData() {
        val symbols =
            DecimalSymbols.newEnForTesting().copy(
                groupingSizes =
                    GroupingSizes(
                        minGrouping = 1u,
                        primary = 3u,
        ...
        val formatter =
            DecimalFormatter.tryNewUnstable(
                symbols = symbols,
                digits = "0123456789",
